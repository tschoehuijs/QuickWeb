...
void QuickWeb::print( WiFiClient client ){
	...
	switch(_type) {
		...
		case 1:{ // lights (living room)
			...
			html = "<div class=\"card\">\r\n<div class=\"container\">\r\n<img src=\"https://cdn.jsdelivr.net/gh/tschoehuijs/tschoehuijs.github.io/Images/Node3.png\" alt=\"Lights\" height=\"90\" style=\"padding-top: 15px; margin-bottom: -10px;\">\r\n<p>Living Room</p>\r\n</div><br><br><br>\r\n<a href=\"light=toggle\"><button class=\"lights @1\" style=\"padding-top: 15px;\">@1</button>\r\n</a>\r\n</div>\r\n";
